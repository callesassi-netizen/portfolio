...
(function () {
  ...
  var SV = {
    ...
    svcLead: 'Sju områden som går in i varandra. De flesta kunder börjar med ett och lägger till fler när det första sitter.',
    v1t: 'Hemsidor',
    ...
    v7t: 'Tillgänglighet & lagkrav',
    v7b: 'Granskning av e-handel mot tillgänglighetslagen, lag (2023:254), på samma tre delar som Post- och telestyrelsen granskar. Varje fel med radnummer, plus den redogörelse 25 § kräver.',
    ...
    chipOwnCss: 'Egen CSS',
    chipOwnPlugin: 'Eget plugin',
    chipQa: 'Kvalitetsgranskning',
    ...
    c10sub: 'tandvård',
    c10: 'Ny premiumsajt för en tandläkarmottagning i Östersund. Designen togs fram som en prototyp i kod, fördes via Figma in i Wix Studio och finslipades med egen CSS - sju sidor, anpassade för mobil.',
    c11sub: 'elpriser',
  ...
  var EN = {
    ...
    svcLead: 'Seven areas that feed into each other. Most clients start with one and add more once the first is running.',
    v1t: 'Websites',
    ...
    v7t: 'Accessibility & compliance',
    v7b: 'Audits of e-commerce against the Swedish accessibility act, on the same three parts the regulator checks. Every issue with a line number, plus the statement the law requires.',
    ...
    chipOwnCss: 'Custom CSS',
    chipOwnPlugin: 'Custom plugin',
    chipQa: 'Quality review',
    ...
    c10sub: 'dental clinic',
    c10: 'A new premium website for a dental clinic in Östersund. The design was built as a coded prototype, brought into Wix Studio via Figma and refined with custom CSS - seven pages, adapted for mobile.',
    c11sub: 'electricity prices',
