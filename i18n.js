...
(function () {
  ...
  var SV = {
    ...
    v1t: 'Hemsidor',
    v1b: 'Nya sajter och omgörningar av gamla — mestadels i WordPress, men handbyggt i kod när det passar bättre. Struktur, texter, bilder och det tekniska bakom, så att sidan blir lika begriplig för besökaren som för Google.',
    v2t: 'E-handel',
  ...
  var EN = {
    ...
    v1t: 'Websites',
    v1b: 'New sites and rebuilds of old ones — mostly in WordPress, but hand-coded where that fits better. Structure, copy, images and the technical work behind it, so the site makes as much sense to a visitor as it does to Google.',
    v2t: 'E-commerce',
